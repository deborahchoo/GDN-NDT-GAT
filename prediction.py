...
class Predictor:
    """GDN-NDT predictor class.

    :param model: GDN-NDT model (pre-trained) used to forecast
    ...
    def predict_anomalies(self, train, test, true_anomalies, load_scores=False, save_output=True,
        ...
        print(f"Results using NDT method:\n {e_eval}")
        ...
        # Save anomaly predictions made using NDT method (could be changed to pot or bf-method)
        if save_output:
